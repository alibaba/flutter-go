...
class HapticFeedback {
  ...
  /// Provides a haptic feedback corresponding a collision impact with a light
  /// mass.
  ///
  ...
  /// below 10.
  ///
  /// On Android, this uses `HapticFeedbackConstants.CONTEXT_CLICK` on API
  /// levels 23 and above. This call has no effects on Android API levels
  /// below 23.
  ...
  /// Provides a haptic feedback indication selection changing through discrete
  /// values.
  ///
